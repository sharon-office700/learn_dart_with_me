...
greetUser() async {
  print("printing from greetUser() => ${addHello(await fetchUsername())}");
...
// to log out the user.
sayGoodbye() async {
  // var print_hold = await logoutUser();
  // print("running sayGoodbye function : ${print_hold}");
  
  try {
    var hold = await logoutUser();
    // print(hold);
    return "$hold Thanks, see you next time";
  } catch (e) {
    return "LogOutUser fails 🟠";
  }
}
